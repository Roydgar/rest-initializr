...
public class VelocityTemplateParserTest {
    ...
    private VelocityTemplateParser subject;

    @Before
    public void setUp() {
        this.subject = new VelocityTemplateParser(velocityEngine, templateProperties);
    }
    ...
    public void parseTemplate_preparesTemplatePath() {
        ...
        assertThat(stringCaptor.getValue()).isEqualTo(
                ...
                + File.separator
                + templateProperties.getTemplateTypeToTemplateFileNameMap().get(TemplateType.SERVICE)
                + "."
